            ...
            <div className="container mx-auto px-4 max-w-6xl">
                <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                    ...
                    <div className="w-full lg:w-1/2 text-center lg:text-left">
                        <h2 className="font-montserrat mb-6 text-3xl md:text-4xl font-extrabold text-white opacity-0 animate-fadeIn">
                            Why Shivansh Physiotherapy Centre?
                        </h2>
                        <p className="font-montserrat mb-8 text-lg leading-relaxed text-white opacity-0 animate-fadeIn animate-delay-200">
